...
export const TherapistRegistration: React.FC = () => {
  ...
  const handleSubmit = () => {
    ...
    alert("Registration Details Captured. Proceeding to Document Upload.");
    // Navigate with the selected language code to trigger translation
    window.location.hash = `#/${formData.language}/therapist-dashboard`;
  };

...
export const ProfileSetup: React.FC = () => {
  ...
  const handleSubmit = () => {
    if (!formData.fullName || !formData.age || !formData.gender || !formData.language || !formData.consent) {
        alert("Please fill in all required fields, select a preferred language, and accept the terms.");
        return;
    }
    // Navigate to Wellness Check (Assessment) with the SELECTED language code
    // This triggers the app router to switch the language globally
    window.location.hash = `#/${formData.language}/assessment`;
  };

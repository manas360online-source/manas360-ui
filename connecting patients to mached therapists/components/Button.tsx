...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "px-8 py-4 rounded-full font-bold text-lg transition-all duration-200 shadow-md hover:shadow-xl active:scale-95 flex items-center justify-center gap-3";

...
export const DoctorSelection: React.FC<DoctorSelectionProps> = ({ role }) => {
  ...
  const handlePayment = () => {
      ...
      confirmBooking(
          ...
          doctor.price, 
          confirmPhone || '+91 99999 99999' // Default phone since input page is removed
      );
                           ...
                           {mockDates.map((d, i) => {
                               ...
                               return (
                                   <button 
                                    ...
                                    className={`min-w-[4.5rem] flex-1 p-3 rounded-2xl flex flex-col items-center transition-all border-2 ${
                                        selected
                           ...
                           <div className="grid grid-cols-2 gap-3">
                               {times.map((t, i) => (
                                   <button 
                                    ...
                                    className={`p-3 rounded-xl text-base font-bold border-2 transition-all ${
                                        t === selectedTime 

import { SessionTemplate, SessionResult } from '../components/cbt/types';
import { QuestionType } from '../components/cbt/types';

const TEMPLATES_KEY = 'mindframe_templates';
const RESULTS_KEY = 'mindframe_results';

...
import { MessageCircle, Clock, Layout, PlayCircle, BookOpen, CheckCircle, Award, ArrowLeft } from 'lucide-react';

interface CBTCourseOverviewProps {
    onStartModule: () => void;
    onBack: () => void;
}

const CBTCourseOverview: React.FC<CBTCourseOverviewProps> = ({ onStartModule, onBack }) => {
    return (
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 flex flex-col md:flex-row gap-8 items-start">
                ...
                <div className="flex-1">
                    <h1 className="text-3xl font-bold text-gray-900 mb-2">What Good CBT Looks Like</h1>
                    <div className="flex items-center text-gray-500 mb-4 space-x-4 text-sm">
                        <span className="flex items-center"><Clock className="w-4 h-4 mr-1" /> 40 min</span>
                        <span className="flex items-center"><Layout className="w-4 h-4 mr-1" /> 8 modules</span>
                    </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                    ...
                    <ul className="space-y-4">
                        {[
                            ...
                            "Learn the structure of a standard 50-minute session",
                            "Master the art of collaborative agenda setting",
                            "Observe Socratic questioning in practice"
                        ].map((obj, i) => (
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center p-3 bg-teal-50 rounded-lg border border-teal-100 text-teal-900 font-medium">
                                ...
                                Pass the CBT comprehension quiz (85%+)
                            </div>
                            <div className="flex items-center p-3 bg-indigo-50 rounded-lg border border-indigo-100 text-indigo-900 font-medium">
                                ...
                                Submit one practice session reflection
                            </div>
                            <div className="flex items-center p-3 bg-green-50 rounded-lg border border-green-100 text-green-900 font-medium">
                                ...
                                Earn MANAS360 CBT Facilitator Badge
                            </div>
                        </div>
                    </div>
...
export default CBTCourseOverview;

...
import { Brain, Clock, Layout, PlayCircle, BookOpen, CheckCircle, Award, ArrowLeft } from 'lucide-react';

interface NLPCourseOverviewProps {
    onStartModule: () => void;
    onBack: () => void;
}

const NLPCourseOverview: React.FC<NLPCourseOverviewProps> = ({ onStartModule, onBack }) => {
    return (
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 flex flex-col md:flex-row gap-8 items-start">
                ...
                <div className="flex-1">
                    <h1 className="text-3xl font-bold text-gray-900 mb-2">Fundamentals of NLP</h1>
                    <div className="flex items-center text-gray-500 mb-4 space-x-4 text-sm">
                        <span className="flex items-center"><Clock className="w-4 h-4 mr-1" /> 60 min</span>
                        <span className="flex items-center"><Layout className="w-4 h-4 mr-1" /> 12 modules</span>
                    </div>
                    <div className="flex flex-wrap gap-2 mb-6">
                        ...
                        <span className="px-3 py-1 bg-amber-50 text-amber-700 text-xs font-bold rounded-lg border border-amber-100">All Roles</span>
                    </div>
                    <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                    ...
                    <ul className="space-y-4">
                        {[
                            "Understand the Presuppositions of NLP",
                            "Master Rapport Building Techniques",
                            "Develop Sensory Acuity",
                            "Apply the Meta Model for precision",
                            "Utilize Anchoring for state management",
                            "Explore Representational Systems"
                        ].map((obj, i) => (
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center p-3 bg-teal-50 rounded-lg border border-teal-100 text-teal-900 font-medium">
                                ...
                                Pass the NLP Practitioner Quiz (85%+)
                            </div>
                            <div className="flex items-center p-3 bg-indigo-50 rounded-lg border border-indigo-100 text-indigo-900 font-medium">
                                ...
                                Submit Rapport Building Reflection
                            </div>
                            <div className="flex items-center p-3 bg-green-50 rounded-lg border border-green-100 text-green-900 font-medium">
                                ...
                                Earn MANAS360 NLP Practitioner Badge
                            </div>
                        </div>
                    </div>
...
export default NLPCourseOverview;

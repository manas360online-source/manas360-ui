...
import { X, CheckCircle, ShieldCheck, CreditCard, AlertCircle, Lock, ArrowRight } from 'lucide-react';
        ...
        {step === 'plan' && (
          <div className="p-8">
            ...
            <div className="mb-6">
              ...
              <p className="text-slate-600 text-sm mt-1">{certification.duration_weeks} Weeks • {certification.modulesCount} Modules</p>
            </div>

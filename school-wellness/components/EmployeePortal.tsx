...
// Fix: Use StudentEnrollment instead of ChallengeEnrollment as it is the correct type from types.ts
import { User, WellnessChallenge, StudentEnrollment as ChallengeEnrollment } from '../types';
  ...
  const [enrollments, setEnrollments] = useState<ChallengeEnrollment[]>([
    {
      id: 'en-initial',
      challenge_id: 'ch-1',
      // Fix: Change patient_id to student_id to match the StudentEnrollment type
      student_id: user.id,
